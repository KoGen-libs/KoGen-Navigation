...
import kz.evko.navigation.booleanAnnotationParameterByNameOrNull
...
import kz.evko.navigation.stringAnnotationParameterByNameOrNull
 ...
 * wins; every other one is reported via [logger] as a warning.
 */
